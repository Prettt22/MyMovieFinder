...
public class TvModel implements Serializable {
    ...
    public String getCreatedByString() {
        return createdBy.stream().map(Creator::getName).collect(Collectors.joining(", "));
    }
    ...
    public String getProductionCompaniesString() {
        return productionCompanies.stream().map(ProductionCompany::getName).collect(Collectors.joining(", "));
    }

    public String getProductionCountriesString() {
        return productionCountries.stream().map(ProductionCountry::getName).collect(Collectors.joining(", "));
    }

    public String getSpokenLanguagesString() {
        return spokenLanguages.stream().map(SpokenLanguage::getName).collect(Collectors.joining(", "));
    }

    public String getSeasonsString() {
        return seasons.stream().map(season -> "Season " + season.getSeasonNumber() + " (" + season.getEpisodeCount() + " episodes)").collect(Collectors.joining(", "));
    }

    public String getLastEpisodeToAirString() {
        return lastEpisodeToAir.getEpisodeSummary();
    }

    public String getNextEpisodeToAirString() {
        return nextEpisodeToAir.getEpisodeSummary();
    }
    ...
    public static class Episode {
        ...
        public String getEpisodeSummary() {
            return String.format("Episode %d (%s)", episodeNumber, name);
        }
    }
